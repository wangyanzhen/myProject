(function () {
    //->数据源
    var ary = ["img/auto1.jpg", "img/auto2.jpg", "img/auto3.jpg", "img/auto4.jpg","img/auto5.jpg","img/auto6.jpg","img/auto7.jpg","img/auto8.jpg","img/auto9.jpg","img/auto10.jpg"];
    ...
    function bindData() {
        ...
        //inner.innerHTML = str;
        inner.style.width = (count + 1) * 1221 + "px";
    ...
    function tipMove() {
        for (var i = 0; i < tipList.length; i++) {
            ...
            curTip.onmouseover = function () {
                ...
                step = this.index;
                animate(inner, {left: -step * 1221}, 500);
                selectTip();
